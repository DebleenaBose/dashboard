...
export declare class StockChartRowDirective extends ComplexBase<StockChartRowDirective> {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<StockChartRowDirective>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDefWithMeta<StockChartRowDirective, "e-stockchart-rows>e-striplines>e-stockchart-row", never, {
    "border": "border";
    "height": "height";
}, {}, never>;
}
...
export declare class StockChartRowsDirective extends ArrayBase<StockChartRowsDirective> {
    constructor();
    static ɵfac: ɵngcc0.ɵɵFactoryDef<StockChartRowsDirective>;

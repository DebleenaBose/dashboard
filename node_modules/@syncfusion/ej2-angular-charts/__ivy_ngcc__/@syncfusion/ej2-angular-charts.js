...
StockChartStripLineDirective.ɵfac = function StockChartStripLineDirective_Factory(t) { return new (t || StockChartStripLineDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ViewContainerRef)); };
StockChartStripLineDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: StockChartStripLineDirective, selectors: [["e-stockchart-stripline"]], inputs: { border: "border", color: "color", dashArray: "dashArray", delay: "delay", duration: "duration", enable: "enable", end: "end", horizontalAlignment: "horizontalAlignment", isRepeat: "isRepeat", isSegmented: "isSegmented", opacity: "opacity", repeatEvery: "repeatEvery", repeatUntil: "repeatUntil", rotation: "rotation", segmentAxisName: "segmentAxisName", segmentEnd: "segmentEnd", segmentStart: "segmentStart", size: "size", sizeType: "sizeType", start: "start", startFromAxis: "startFromAxis", text: "text", textStyle: "textStyle", verticalAlignment: "verticalAlignment", visible: "visible", zIndex: "zIndex" }, features: [ɵngcc0.ɵɵInheritDefinitionFeature] });
/**
 * @nocollapse
 */
...
StockChartStripLinesDirective.ɵfac = function StockChartStripLinesDirective_Factory(t) { return new (t || StockChartStripLinesDirective)(); };
StockChartStripLinesDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: StockChartStripLinesDirective, selectors: [["e-stockchart-striplines"]], contentQueries: function StockChartStripLinesDirective_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, StockChartStripLineDirective, false);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.children = _t);
    } }, features: [ɵngcc0.ɵɵInheritDefinitionFeature] });
...
StockChartAxisDirective.ɵdir = ɵngcc0.ɵɵdefineDirective({ type: StockChartAxisDirective, selectors: [["e-stockchart-axis"]], contentQueries: function StockChartAxisDirective_ContentQueries(rf, ctx, dirIndex) { if (rf & 1) {
        ɵngcc0.ɵɵcontentQuery(dirIndex, StockChartStripLinesDirective, true);
    } if (rf & 2) {
        var _t;
        ɵngcc0.ɵɵqueryRefresh(_t = ɵngcc0.ɵɵloadQuery()) && (ctx.childStripLines = _t.first);
    } }, inputs: { coefficient: "coefficient", crossesAt: "crossesAt", crossesInAxis: "crossesInAxis", crosshairTooltip: "crosshairTooltip", description: "description", desiredIntervals: "desiredIntervals", edgeLabelPlacement: "edgeLabelPlacement", enableAutoIntervalOnZooming: "enableAutoIntervalOnZooming", enableTrim: "enableTrim", interval: "interval", intervalType: "intervalType", isInversed: "isInversed", labelFormat: "labelFormat", labelIntersectAction: "labelIntersectAction", labelPlacement: "labelPlacement", labelPosition: "labelPosition", labelRotation: "labelRotation", labelStyle: "labelStyle", lineStyle: "lineStyle", logBase: "logBase", majorGridLines: "majorGridLines", majorTickLines: "majorTickLines", maximum: "maximum", maximumLabelWidth: "maximumLabelWidth", maximumLabels: "maximumLabels", minimum: "minimum", minorGridLines: "minorGridLines", minorTickLines: "minorTickLines", minorTicksPerInterval: "minorTicksPerInterval", name: "name", opposedPosition: "opposedPosition", placeNextToAxisLine: "placeNextToAxisLine", plotOffset: "plotOffset", rangePadding: "rangePadding", rowIndex: "rowIndex", skeleton: "skeleton", skeletonType: "skeletonType", span: "span", startAngle: "startAngle", stripLines: "stripLines", tabIndex: "tabIndex", tickPosition: "tickPosition", title: "title", titleStyle: "titleStyle", valueType: "valueType", visible: "visible", zoomFactor: "zoomFactor", zoomPosition: "zoomPosition" }, features: [ɵngcc0.ɵɵInheritDefinitionFeature] });
/**
 * @nocollapse
 */
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(StockChartStripLineDirective, [{
        type: Directive,
        args: [{
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(StockChartStripLinesDirective, [{
        type: Directive,
        args: [{

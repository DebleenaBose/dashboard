...
export declare class StripLineDirective extends ComplexBase<StripLineDirective> {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<StripLineDirective>;
    static ɵdir: ɵngcc0.ɵɵDirectiveDefWithMeta<StripLineDirective, "e-axis>e-striplines>e-stripline", never, {
    "border": "border";
    "color": "color";
    "dashArray": "dashArray";
    "end": "end";
...
export declare class StripLinesDirective extends ArrayBase<StripLinesDirective> {
    constructor();
    static ɵfac: ɵngcc0.ɵɵFactoryDef<StripLinesDirective>;
